...
class FileUploadWorker(val appContext: Context, workerParams: WorkerParameters) : CoroutineWorker(appContext, workerParams) {
        ...
        try {
          //  applicationContext.sendNotification("File Upload in Progress", "File upload in Progress.")
            ...
            if (response.isSuccessful) {
                ...
                applicationContext.sendNotification("File Upload Failed", "File upload failed. ${response.errorBody()}")
